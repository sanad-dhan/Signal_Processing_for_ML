...
featureSize=14; % mfcc gives 13 by default +1 for volume
...
for i=1:numIterations
    ...
    if length(testFiles)>8  % not used in training D
        fileIdx=randi([8,length(testFiles)]);
    else
